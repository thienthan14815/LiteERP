...
export default function SaleDetailPage() {
  ...
  const { data, isLoading, isError } = useSale(params.id);
                ...
                <TableRow key={it.id}>
                  ...
                  <TableCell className="font-medium">
                    {it.itemType === SalesItemType.FINISHED_PC && it.finishedPc ? (
                      <Link href={`/finished-pcs/${it.finishedPc.id}`} className="underline">
                        {it.finishedPc.code}
                      </Link>
                    ) : it.component ? (
                      <Link href={`/components/${it.component.id}`} className="underline">
                        {it.component.code}
                      </Link>
                    ) : "-"}
                  </TableCell>
